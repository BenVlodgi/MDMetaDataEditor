...
=======
		FMDMetaDataKey{ TEXT("BaseStruct"), EMDMetaDataEditorKeyType::String, LOCTEXT("BaseStruct_Description", "The minimum allowable type holdable by this struct.") }.SetSupportedProperties(InstancedStructs),
		FMDMetaDataKey{ TEXT("ExcludeBaseStruct"), EMDMetaDataEditorKeyType::Flag, LOCTEXT("ExcludeBaseStruct_Description", "Only allow subclasses of the BaseStruct type.") }.SetSupportedProperties(InstancedStructs).SetRequiredMetaData(TEXT("BaseStruct")),
		FMDMetaDataKey{ TEXT("AllowedClasses"), EMDMetaDataEditorKeyType::String, LOCTEXT("AllowedClasses_Description", "Inclusive list of allowed struct classes.") }.SetSupportedProperties(InstancedStructs).SetDisplayNameOverride(LOCTEXT("InstancedStruct_AllowedClasses_DisplayName","Allowed Struct Classes")),
		FMDMetaDataKey{ TEXT("DisallowedClasses"), EMDMetaDataEditorKeyType::String, LOCTEXT("DisallowedClasses_Description", "List of struct classes to hide from picker.") }.SetSupportedProperties(InstancedStructs).SetDisplayNameOverride(LOCTEXT("InstancedStruct_DisallowedClasses_DisplayName","Disallowed Struct Classes")),
		FMDMetaDataKey{ TEXT("ShowTreeView"), EMDMetaDataEditorKeyType::Flag, LOCTEXT("ShowTreeView_Description", "Dispay the Struct Class picker as a tree view.") }.SetSupportedProperties(InstancedStructs),
		FMDMetaDataKey{ TEXT("StructTypeConst"), EMDMetaDataEditorKeyType::Flag, LOCTEXT("StructTypeConst_Description", "Struct class cannot be changed.") }.SetSupportedProperties(InstancedStructs).SetDisplayNameOverride(LOCTEXT("InstancedStruct_StructTypeConst_DisplayName","Struct Type is Constant")),
>>>>>>> Stashed changes
	});
